...
func TestSendWithMessage(t *testing.T) {
	...
	msg := NewMessage(ChatID, "A test message from the test library in tg-bot")
...
func TestSendWithMediaGroupPhotoVideo(t *testing.T) {
	...
	cfg := NewMediaGroup(ChatID, []interface{}{
		NewInputMediaPhoto(FileURL("https://github.com/crocone/tg-bot/raw/0a3a1c8716c4cd8d26a262af9f12dcbab7f3f28c/tests/image.jpg")),
...
func TestPinChatMessage(t *testing.T) {
	...
	msg := NewMessage(SupergroupChatID, "A test message from the test library in tg-bot")
	msg.ParseMode = ModeMarkdown
	message, _ := bot.Send(msg)
